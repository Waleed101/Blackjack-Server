...
{cards.map((card, index) => {
    ...
    return (
      ...
      <div
        ...
        className={`flex justify-center items-center text-6xl text-[#6D5C5C] bg-cover w-[8.5rem] h-[13.5rem] -ml-6 animate-getCard -rotate-8 ${sendToAbove}`}
      >
        {cardNo}
        {suit}
      </div>
